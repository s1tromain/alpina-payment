...
module.exports = async (req, res) => {
  ...
  try {
    ...
    // Atomic lock: prevent double submission to Telegram channel
    const submitLockKey = 'order:submit:' + orderId;
    const submitLocked = await r.set(submitLockKey, '1', { nx: true, ex: 60 });
    if (!submitLocked) {
      return res.status(409).json({ ok: false, error: '\u0417\u0430\u044F\u0432\u043A\u0430 \u0443\u0436\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u044F\u0435\u0442\u0441\u044F. \u041F\u043E\u0434\u043E\u0436\u0434\u0438\u0442\u0435.' });
    }
    ...
    return res.status(200).json({ ok: true, orderId });
      ...
      try { await r.del(submitLockKey); } catch (_) {}
    }
  } catch (err) {
